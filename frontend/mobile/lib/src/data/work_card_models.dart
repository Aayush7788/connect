...
class WorkCardResult {
  const WorkCardResult({
    required this.id,
  ...
  factory WorkCardResult.fromJson(Map<String, dynamic> json) {
  ...
  String get displayWorkName =>
      workName ?? customWorkName ?? (title.isEmpty ? 'Untitled work' : title);
