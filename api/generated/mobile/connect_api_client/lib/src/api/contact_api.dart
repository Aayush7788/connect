...
class ContactApi {
  ...
  Future<Response<void>> createContactAction({ 
    required ContactActionRequest contactActionRequest,
    ...
    try {
      _bodyData = jsonEncode(contactActionRequest);
