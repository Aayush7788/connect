...
class MeApi {
  ...
  Future<Response<OwnerProfileResponse>> completeMyProfile({ 
    ...
    final _path = r'/me/profile/complete';
    ...
    OwnerProfileResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<OwnerProfileResponse, OwnerProfileResponse>(rawData, 'OwnerProfileResponse', growable: true);
    ...
    return Response<OwnerProfileResponse>(
      data: _responseData,
  ...
  Future<Response<MeResponse>> getMe({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MeResponse, MeResponse>(rawData, 'MeResponse', growable: true);
