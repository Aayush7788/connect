...
class WorkCardsApi {
  ...
  Future<Response<WorkCard>> createWorkCard({ 
    ...
    try {
      _bodyData = jsonEncode(workCardUpsertRequest);
    ...
    WorkCard? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<WorkCard, WorkCard>(rawData, 'WorkCard', growable: true);
  ...
  Future<Response<void>> deleteWorkCard({ 
    ...
    final _path = r'/me/work-cards/{work_card_id}'.replaceAll('{' r'work_card_id' '}', workCardId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<WorkCard>> hideWorkCard({ 
    ...
    final _path = r'/me/work-cards/{work_card_id}/hide'.replaceAll('{' r'work_card_id' '}', workCardId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<WorkCard, WorkCard>(rawData, 'WorkCard', growable: true);
  ...
  Future<Response<ListMyWorkCards200Response>> listMyWorkCards({ 
    ...
    ListMyWorkCards200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListMyWorkCards200Response, ListMyWorkCards200Response>(rawData, 'ListMyWorkCards200Response', growable: true);
    ...
    return Response<ListMyWorkCards200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<WorkCard>> publishWorkCard({ 
    ...
    final _path = r'/me/work-cards/{work_card_id}/publish'.replaceAll('{' r'work_card_id' '}', workCardId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (idempotencyKey != null) r'Idempotency-Key': idempotencyKey,
...
_responseData = rawData == null ? null : deserialize<WorkCard, WorkCard>(rawData, 'WorkCard', growable: true);
  ...
  Future<Response<WorkCard>> showWorkCard({ 
    ...
    final _path = r'/me/work-cards/{work_card_id}/show'.replaceAll('{' r'work_card_id' '}', workCardId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
