...
class WorkNeededPostsApi {
  ...
  Future<Response<WorkNeededPost>> closeWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts/{post_id}/close'.replaceAll('{' r'post_id' '}', postId.toString());
    ...
    WorkNeededPost? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<WorkNeededPost, WorkNeededPost>(rawData, 'WorkNeededPost', growable: true);
    ...
    return Response<WorkNeededPost>(
      data: _responseData,
  ...
  Future<Response<WorkNeededPost>> createWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(workNeededPostUpsertRequest);
...
_responseData = rawData == null ? null : deserialize<WorkNeededPost, WorkNeededPost>(rawData, 'WorkNeededPost', growable: true);
  ...
  Future<Response<void>> deleteWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts/{post_id}'.replaceAll('{' r'post_id' '}', postId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ListMyWorkNeededPosts200Response>> listMyWorkNeededPosts({ 
    ...
    ListMyWorkNeededPosts200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListMyWorkNeededPosts200Response, ListMyWorkNeededPosts200Response>(rawData, 'ListMyWorkNeededPosts200Response', growable: true);
    ...
    return Response<ListMyWorkNeededPosts200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<WorkNeededPost>> pauseWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts/{post_id}/pause'.replaceAll('{' r'post_id' '}', postId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<WorkNeededPost, WorkNeededPost>(rawData, 'WorkNeededPost', growable: true);
  ...
  Future<Response<WorkNeededPost>> publishWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts/{post_id}/publish'.replaceAll('{' r'post_id' '}', postId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (idempotencyKey != null) r'Idempotency-Key': idempotencyKey,
...
_responseData = rawData == null ? null : deserialize<WorkNeededPost, WorkNeededPost>(rawData, 'WorkNeededPost', growable: true);
  ...
  Future<Response<WorkNeededPost>> resumeWorkNeededPost({ 
    ...
    final _path = r'/me/work-needed-posts/{post_id}/resume'.replaceAll('{' r'post_id' '}', postId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
