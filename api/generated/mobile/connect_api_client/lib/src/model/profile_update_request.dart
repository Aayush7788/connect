...
class ProfileUpdateRequest {
  ...
  @JsonKey(name: r'owner_name', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'address_line1', required: false, includeIfNull: false)
  final String? addressLine1;

  @JsonKey(name: r'address_line2', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'business_name', required: false, includeIfNull: false)
  final String? businessName;

  @JsonKey(name: r'business_category_id', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'product_notes', required: false, includeIfNull: false)
  final String? productNotes;

  @JsonKey(name: r'product_type_ids', required: false, includeIfNull: false)
  final List<String>? productTypeIds;

  @JsonKey(name: r'custom_product_types', required: false, includeIfNull: false)
  final List<String>? customProductTypes;

  @JsonKey(name: r'workshop_name', required: false, includeIfNull: false)
  final String? workshopName;

  @JsonKey(name: r'has_workshop', required: false, includeIfNull: false)
  final bool? hasWorkshop;

  @JsonKey(name: r'work_summary', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'skill_mastery', required: false, includeIfNull: false)
  final String? skillMastery;

  // minimum: 0
  // maximum: 100
  @JsonKey(name: r'experience_years', required: false, includeIfNull: false)
