  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AdminApproveVerificationCaseRequest':
          return AdminApproveVerificationCaseRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminProfile':
          return AdminProfile.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminProfilesResponse':
          return AdminProfilesResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminReportsResponse':
          return AdminReportsResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminSeedProfileRequest':
          return AdminSeedProfileRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminUser':
          return AdminUser.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminVerificationCase':
          return AdminVerificationCase.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminVerificationCasePrivateDocumentAccessInner':
          return AdminVerificationCasePrivateDocumentAccessInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AdminVerificationCasesResponse':
          return AdminVerificationCasesResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'ContactActionRequest':
          return ContactActionRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateExportRequest':
          return CreateExportRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateReportRequest':
          return CreateReportRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateShareLinkRequest':
          return CreateShareLinkRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'DeviceInfo':
        ...
        case 'NotificationsResponse':
          return NotificationsResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OtpRequest':
        ...
        case 'PublicContact':
          return PublicContact.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PublicProfileDetail':
          return PublicProfileDetail.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'VerificationSummarySafeDocumentsInner':
          return VerificationSummarySafeDocumentsInner.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'WorkCard':
